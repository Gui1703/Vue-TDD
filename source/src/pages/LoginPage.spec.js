...
describe("Login Page", () => {
  ...
  describe("Internationalization", () => {
    ...
    it("initially displays all text in English", async () => {
      setupTranslation();
      expect(screen.queryByRole("heading", { name: en.login }))
        .toBeInTheDocument;
      expect(screen.queryByRole("button", { name: en.login }))
        .toBeInTheDocument;
    ...
    it("display all text in portuguese after changing language", async () => {
      ...
      expect(screen.queryByRole("heading", { name: pt.login }))
        .toBeInTheDocument;
      expect(screen.queryByRole("button", { name: pt.login }))
        .toBeInTheDocument;
